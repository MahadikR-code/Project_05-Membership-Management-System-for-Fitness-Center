...
public class MembershipManagement {
	...
	private void printClubOptions() {
		System.out.println("\n1) club Indian");
		System.out.println("2) club Builder ");
		System.out.println("3) club BodyMonster");
		System.out.println("4) Multi Clubs");
	}

	public int getChoice() {
		int choice;
		System.out.println("\n Welcome to fiteness Freak Club");
		System.out.println("==============================");
		System.out.println("1) Add Member");
		System.out.println("2) Remove Member");
		System.out.println("3) Display Member Information");
		System.out.println("please select option (or enter -1 to quit");
		choice = getInput();
		return choice;
	}
